 ...
 */
public class OpenChargerInteraction extends SimpleBlockInteraction {
    public static final BuilderCodec<OpenChargerInteraction> CODEC;

    public OpenChargerInteraction() {
    }
    ...
    protected void interactWithBlock(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nullable ItemStack itemInHand, @Nonnull Vector3i pos, @Nonnull CooldownHandler cooldownHandler) {
        ...
        if (playerComponent != null) {
            ...
            playerComponent.getPageManager().openCustomPage(ref, store, new ChargerPage(commandBuffer.getComponent(ref, PlayerRef.getComponentType()), CommonPage.CommonData.CODEC, pos));
        }
    }
    ...
    static {
        CODEC = (BuilderCodec.builder(OpenChargerInteraction.class, OpenChargerInteraction::new, SimpleBlockInteraction.CODEC)).build();
    }
}
