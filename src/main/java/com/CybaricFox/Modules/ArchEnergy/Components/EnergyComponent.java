package com.CybaricFox.Modules.ArchEnergy.Components;
...
public class EnergyComponent implements Component<ChunkStore>, IDataPanel {
    ...
    //Returns the amount of energy that will be transferred
    ...
    public static ComponentType<ChunkStore, EnergyComponent> getComponentType() {
        return ArchEnergyModule.get().getEnergyComponentType();
    }
    ...
    public ArrayList<String> getData() {
        ...
        switch (getType()) {
            case CONSUMER -> returnData.add("Consumption Per Tick: " + getProductionRate() + "v");
            case PRODUCER -> {
                returnData.add("Production Per Tick: " + getProductionRate() + "v");
                returnData.add("Current Output: " + getOutputThisTick() + "v");
            }
            case STORAGE -> {
                returnData.add("Current Input: " + getInputThisTick() + "v");
                returnData.add("Current Output: " + getOutputThisTick() + "v");
            }
        }
